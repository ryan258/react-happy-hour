export default [
    ...
    happyHours: [
      {
        ...
        specials: [
          '$2.50 House Spirits',
          '$2.50 16oz Domestic Drafts',
          '$3.50 House Wines',
          '$6.50 48oz Domestic Pitchers',
        ],
        dow: [
          'saturday',
          'sunday',
  ...
  },
  {
    ...
    specials: {
      ...
      wednesday: [
        '$3 House Margaritas (rocks or frozen)',
        '$3 House Tequila',
        '$3 Mexican Bottles',
        '$7.99 Blackened Fish Tacos',
        '$2.99 Chips & Queso (+$1 add salsa)',
      ],
      thursday: [
        '$2.25 Domestic Bottles (after 4pm)',
        "$3 Bartender's Choice Shots",
        '$6 Chicken Chunks during NFL games',
      ],
      friday: [
        '$3 Fireball Shots',
        "$3 Bartender's Choice Shots",
    ...
    happyHours: [
      ...
      },
      {
        ...
        specials: [
          ...
          '$6 Fried Mushrooms',
          '$6 Fried Pickles',
          '$6 Full Order of Onion Rings',
          '$6 Chicken Chunks',
          '$6 1/2 Order of Fully Loaded Cheese Fries',
        ],
        dow: ['monday', 'tuesday', 'wednesday', 'thursday', 'friday'],
      },
      {
  ...
  },
  {
    ...
    location: 'Rogers',
    website:
      'https://locations.walk-ons.com/walk-ons-sports-bistreaux-rogers-3530ddeed003',
